package com.yolanda.recyclerview.itemhandle;
...
import com.yolanda.recyclerview.itemhandle.adapter.MainAdapter;
import com.yolanda.recyclerview.itemhandle.entity.UserInfo;
import com.yolanda.recyclerview.itemhandle.itemtouch.DefaultItemTouchHelpCallback;
import com.yolanda.recyclerview.itemhandle.itemtouch.DefaultItemTouchHelper;
...
//        linearLayoutManager.setOrientation(LinearLayoutManager.HORIZONTAL);// 横着的listview
    ...
    private MainAdapter.OnItemClickListener onItemClickListener = new MainAdapter.OnItemClickListener() {
        ...
        public void onItemClick(View view, int position) {
            Toast.makeText(MainActivity.this, "第" + position + "被点击", Toast.LENGTH_LONG).show();
        }
    };
    ...
    private MainAdapter.OnCheckedChangeListener onCheckedChangeListener = new MainAdapter.OnCheckedChangeListener() {
        ...
        public void onItemCheckedChange(CompoundButton view, int position, boolean checked) {
            Toast.makeText(MainActivity.this, "第" + position + (checked ? "选中" : "被反选"), Toast.LENGTH_LONG).show();
        }
    };
}
